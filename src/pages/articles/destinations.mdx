  ...
  ...[
    ...
    new Map(
      Object.entries({
        ...
        TER: {
          info: "TER trains go from Île-de-France to the rest of France. Places you can go on the TER within Île-de-France include Dourdan, Mantes-la-Jolie and Montereau.",
        },
        "Transilien V": {},
      }),
    ),
